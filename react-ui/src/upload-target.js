...
class UploadTarget extends Component {
  ...
  render() {
    ...
    <g>
      ...
      <svg className="einstein" viewBox="-607 393 512 512">
        <g>
          <g>
        ...
        <g>
          <g id="Layer_2">
            <g id="Layer_2-2">
              <path className="st0 metamind-logo" d="M-511.7,607.5c0,4.8,0,9.6,0,14.4c0,1.1,0,1.1,1,1.5c5.3,1.8,8.2,7.5,6.4,12.8c-1.3,3.9-4.9,6.6-9,6.9
                ...
                />
              <path className="st0 metamind-logo" d="M-480.2,555.3c0.2,7.9,6.1,11.8,11.6,11.8c6.3,0,11.4-5,11.4-11.3c0-0.2,0-0.4,0-0.7
              ...
              <path className="st0 metamind-logo" d="M-477.6,556.1c-0.1-4.1,2.7-7.6,6.7-8.5c4.8-1.3,9.6,1.6,10.9,6.3c0,0.2,0.1,0.4,0.1,0.5
